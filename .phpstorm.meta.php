...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/personal/biggerhat-v3/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/personal/biggerhat-v3/public/storage','horizon.name','horizon.domain','horizon.path',
...
'mail.markdown.theme','mail.markdown.paths','pennant.default','pennant.stores.array.driver','pennant.stores.database.driver',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','scramble.api_path','scramble.api_domain','scramble.export_path',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.browsershot.node_binary','services.browsershot.npm_binary','services.browsershot.chrome_path',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','concurrency.default','laravel-impersonate.session_key',
...
'activitylog.activity_model','activitylog.table_name','activitylog.database_connection','tinker.commands','tinker.alias',
'tinker.dont_alias',);
...
'upgrades.character.index','upgrades.view','packages.index','packages.contents','packages.view',
'blueprints.index','lores.index','blog.index','blog.view','news.index',
'news.view','channels.index','channels.my','channels.view','transmissions.create',
'transmissions.store','transmissions.edit','transmissions.update','transmissions.delete','seasons.index',
'seasons.view','schemes.view','strategies.view','tools.hat_gamin','tools.pdf.index',
'tools.pdf.download','tools.scenario_generator','tools.scheme_paths','tools.random_character','tools.bonanza_loot_deck',
'tools.bonanza_loot_deck.print','tools.compare','tools.card_creator.share','tools.card_creator.upgrades.share','tools.card_creator.capture',
'tools.card_creator.capture_crew_card','tools.card_creator.capture_crew_card_combined','tools.card_creator.index','tools.card_creator.create','tools.card_creator.edit',
'tools.card_creator.upgrades.create','tools.card_creator.upgrades.edit','tools.card_creator.store','tools.card_creator.update','tools.card_creator.destroy',
'tools.card_creator.upgrades.store','tools.card_creator.upgrades.update','tools.card_creator.upgrades.destroy','tools.crew_builder.index','tools.crew_builder.editor',
'tools.crew_builder.references','tools.crew_builder.share','tools.crew_builder.quick_ref','tools.crew_builder.details','tools.crew_builder.store',
'tools.crew_builder.update','tools.crew_builder.destroy','wishlists.share','wishlists.index','wishlists.store',
'wishlists.show','wishlists.update','wishlists.destroy','wishlists.items.add','wishlists.items.remove',
'wishlists.add_keyword','wishlists.toggle_public','games.public','games.observe','games.summary',
'games.join','stats.my','stats.show','games.index','games.create',
'games.store','games.show','games.scenario.update','games.scenario.regenerate','games.destroy',
'games.abandon','games.toggle_observable','games.settings.update','games.setup.faction','games.setup.master',
'games.setup.crew','games.setup.crew.skip','games.setup.campaign-crew','games.setup.scheme','games.setup.swap_roles',
'games.setup.opponent_name','games.play.crew.update','games.play.crew.kill','games.play.crew.revive','games.play.crew.tokens.bulk',
'games.play.crew.tokens.restore','games.play.crew.summon','games.play.crew.replace','games.play.soulstones','games.play.crew-upgrade',
'games.play.crew-upgrade-power-bar','games.play.bonanza_vp','games.play.bonanza_next_turn','games.play.loot.draw','games.play.loot.select',
'games.play.loot.attach','games.play.loot.yoink','games.play.scheme-notes','games.play.turns.store','games.play.turns.edit',
'games.play.complete','games.play.cancel_complete','metas.index','metas.store','tournaments.index',
'tournaments.view','tournaments.create','tournaments.store','tournaments.manage','tournaments.update',
'tournaments.destroy','tournaments.status','tournaments.organizers.add','tournaments.organizers.remove','tournaments.rsvp',
'tournaments.rsvp.cancel','tournaments.users.search','tournaments.players.add','tournaments.players.update','tournaments.players.remove',
'tournaments.rounds.create','tournaments.rounds.generate_all','tournaments.rounds.update','tournaments.rounds.delete','tournaments.rounds.pair',
'tournaments.rounds.randomize','tournaments.games.create','tournaments.games.update','tournaments.games.delete','tournaments.games.forfeit',
'tournaments.games.complete_tracker','tournaments.export_csv','collection.share','collection.index','collection.toggle',
'collection.toggle_public','collection.add_character','collection.add_characters','collection.add_package','collection.toggle_package',
'collection.update_status','collection.update_status_bulk','collection.remove','collection.remove_bulk','api.characters.view',
'api.characters.search','api.characters.compare','api.characters.miniatures','api.','api.',
'api.','api.','api.','api.','api.',
'api.keywords.view','api.card-creator.actions','api.card-creator.abilities','api.card-creator.triggers','api.card-creator.keywords',
'api.card-creator.crew-upgrades','api.card-creator.characters','api.card-creator.tokens','api.card-creator.markers','api.card-creator.character-detail',
'api.blog.posts.index','api.blog.entity-search','api.blog.entity-show','overview','profile.edit',
...
'verification.send','password.confirm','logout','admin.dashboard',
'admin.refresh_analytics','admin.activity.index','admin.loot_cards.index','admin.loot_cards.generate_pdf','admin.loot_cards.regenerate',
'admin.loot_cards.data','admin.loot_cards.create','admin.loot_cards.store','admin.loot_cards.edit','admin.loot_cards.update',
'admin.loot_cards.image','admin.loot_cards.destroy','admin.failed_jobs.index','admin.failed_jobs.retry_all','admin.failed_jobs.flush',
'admin.failed_jobs.retry','admin.failed_jobs.delete','admin.features.index','admin.features.update','admin.api_tokens.index',
'admin.api_tokens.store','admin.api_tokens.delete','admin.sessions.index','admin.sessions.delete','admin.sessions.delete_all_for_user',
'admin.custom_cards.index','admin.custom_cards.unpublish','admin.custom_cards.delete','admin.image_health.index','admin.image_health.scan',
'admin.tournaments.index','admin.tournaments.show','admin.tournaments.force_status','admin.tournaments.rounds.force_status','admin.tournaments.delete',
'admin.trash.index','admin.trash.restore','admin.trash.force_delete','admin.maintenance.index','admin.maintenance.down',
'admin.maintenance.up','admin.schedule.index','admin.cache.index','admin.cache.clear','admin.announcements.index',
'admin.announcements.store','admin.announcements.update','admin.announcements.delete','admin.keywords.index','admin.keywords.edit',
'admin.keywords.create','admin.keywords.store','admin.keywords.update','admin.keywords.delete','admin.characteristics.index',
'admin.characteristics.edit','admin.characteristics.create','admin.characteristics.store','admin.characteristics.update','admin.characteristics.delete',
'admin.characters.index','admin.characters.edit','admin.characters.create','admin.characters.store','admin.characters.update',
'admin.characters.delete','admin.actions.index','admin.actions.edit','admin.actions.create','admin.actions.store',
'admin.actions.update','admin.actions.delete','admin.abilities.index','admin.abilities.edit','admin.abilities.create',
'admin.abilities.store','admin.abilities.update','admin.abilities.delete','admin.triggers.index','admin.triggers.edit',
'admin.triggers.create','admin.triggers.store','admin.triggers.update','admin.triggers.delete','admin.miniatures.index',
'admin.miniatures.edit','admin.miniatures.create','admin.miniatures.store','admin.miniatures.update','admin.miniatures.delete',
'admin.upgrades.index','admin.upgrades.edit','admin.upgrades.create','admin.upgrades.store','admin.upgrades.update',
'admin.upgrades.delete','admin.crews.index','admin.crews.edit','admin.crews.create','admin.crews.store',
'admin.crews.update','admin.crews.delete','admin.tokens.index','admin.tokens.edit','admin.tokens.create',
'admin.tokens.store','admin.tokens.update','admin.tokens.delete','admin.markers.index','admin.markers.edit',
'admin.markers.create','admin.markers.store','admin.markers.update','admin.markers.delete','admin.schemes.index',
'admin.schemes.edit','admin.schemes.create','admin.schemes.store','admin.schemes.update','admin.schemes.delete',
'admin.strategies.index','admin.strategies.edit','admin.strategies.create','admin.strategies.store','admin.strategies.update',
'admin.strategies.delete','admin.roles.index','admin.roles.edit','admin.roles.create','admin.roles.store',
'admin.roles.update','admin.roles.delete','admin.users.index','admin.users.edit','admin.users.update',
'admin.users.password_reset_link','admin.users.delete','admin.packages.index','admin.packages.edit','admin.packages.create',
'admin.packages.store','admin.packages.update','admin.packages.delete','admin.lore_media.index','admin.lore_media.edit',
'admin.lore_media.create','admin.lore_media.store','admin.lore_media.update','admin.lore_media.delete','admin.lores.index',
'admin.lores.edit','admin.lores.create','admin.lores.store','admin.lores.update','admin.lores.delete',
'admin.blueprints.index','admin.blueprints.edit','admin.blueprints.create','admin.blueprints.store','admin.blueprints.update',
'admin.blueprints.delete','admin.channels.index','admin.channels.edit','admin.channels.create','admin.channels.store',
'admin.channels.update','admin.channels.delete','admin.transmissions.index','admin.transmissions.edit','admin.transmissions.create',
'admin.transmissions.store','admin.transmissions.update','admin.transmissions.delete','admin.blog.categories.index','admin.blog.categories.edit',
'admin.blog.categories.create','admin.blog.categories.store','admin.blog.categories.update','admin.blog.categories.delete','admin.blog.posts.index',
'admin.blog.posts.preview','admin.blog.posts.edit','admin.blog.posts.create','admin.blog.posts.store','admin.blog.posts.update',
'admin.blog.posts.delete','admin.blog.posts.upload-image','admin.news.categories.index','admin.news.categories.edit','admin.news.categories.create',
'admin.news.categories.store','admin.news.categories.update','admin.news.categories.delete','admin.news.posts.index','admin.news.posts.preview',
'admin.news.posts.edit','admin.news.posts.create','admin.news.posts.store','admin.news.posts.update','admin.news.posts.delete',
'admin.news.posts.upload-image','admin.feedback.index','admin.feedback.update','admin.feedback.delete','admin.pod_links.index',
'admin.pod_links.edit','admin.pod_links.create','admin.pod_links.store','admin.pod_links.update','admin.pod_links.delete',
'admin.tos.allegiances.index','admin.tos.allegiances.edit','admin.tos.allegiances.create','admin.tos.allegiances.store','admin.tos.allegiances.update',
'admin.tos.allegiances.delete','admin.tos.units.index','admin.tos.units.edit','admin.tos.units.create','admin.tos.units.store',
'admin.tos.units.update','admin.tos.units.delete','admin.tos.sculpts.index','admin.tos.sculpts.edit','admin.tos.sculpts.create',
'admin.tos.sculpts.store','admin.tos.sculpts.update','admin.tos.sculpts.delete','admin.tos.abilities.index','admin.tos.abilities.edit',
'admin.tos.abilities.create','admin.tos.abilities.store','admin.tos.abilities.update','admin.tos.abilities.delete','admin.tos.actions.index',
'admin.tos.actions.edit','admin.tos.actions.create','admin.tos.actions.store','admin.tos.actions.update','admin.tos.actions.delete',
'admin.tos.triggers.index','admin.tos.triggers.edit','admin.tos.triggers.create','admin.tos.triggers.store','admin.tos.triggers.update',
'admin.tos.triggers.delete','admin.tos.special_rules.index','admin.tos.special_rules.edit','admin.tos.special_rules.create','admin.tos.special_rules.store',
'admin.tos.special_rules.update','admin.tos.special_rules.delete','admin.tos.allegiance_cards.index','admin.tos.allegiance_cards.edit','admin.tos.allegiance_cards.create',
'admin.tos.allegiance_cards.store','admin.tos.allegiance_cards.update','admin.tos.allegiance_cards.delete','admin.tos.assets.index','admin.tos.assets.edit',
'admin.tos.assets.create','admin.tos.assets.store','admin.tos.assets.update','admin.tos.assets.delete','admin.tos.stratagems.index',
'admin.tos.stratagems.edit','admin.tos.stratagems.create','admin.tos.stratagems.store','admin.tos.stratagems.update','admin.tos.stratagems.delete',
'admin.campaign.crew-cards.index','admin.campaign.crew-cards.edit','admin.campaign.crew-cards.create','admin.campaign.crew-cards.store','admin.campaign.crew-cards.update',
'admin.campaign.crew-cards.delete','admin.campaign.totem-templates.index','admin.campaign.totem-templates.edit','admin.campaign.totem-templates.create','admin.campaign.totem-templates.store',
'admin.campaign.totem-templates.update','admin.campaign.totem-templates.delete','admin.campaign.lucky-miss.index','admin.campaign.lucky-miss.edit','admin.campaign.lucky-miss.create',
'admin.campaign.lucky-miss.store','admin.campaign.lucky-miss.update','admin.campaign.lucky-miss.delete','admin.campaign.back-alley-doctor.index','admin.campaign.back-alley-doctor.edit',
'admin.campaign.back-alley-doctor.create','admin.campaign.back-alley-doctor.store','admin.campaign.back-alley-doctor.update','admin.campaign.back-alley-doctor.delete','admin.campaign.weekly-events.index',
'admin.campaign.weekly-events.edit','admin.campaign.weekly-events.create','admin.campaign.weekly-events.store','admin.campaign.weekly-events.update','admin.campaign.weekly-events.delete',
'admin.campaign.advancement-attack-mod.index','admin.campaign.advancement-attack-mod.edit','admin.campaign.advancement-attack-mod.create','admin.campaign.advancement-attack-mod.store','admin.campaign.advancement-attack-mod.update',
'admin.campaign.advancement-attack-mod.delete','admin.campaign.advancement-tactical-mod.index','admin.campaign.advancement-tactical-mod.edit','admin.campaign.advancement-tactical-mod.create','admin.campaign.advancement-tactical-mod.store',
'admin.campaign.advancement-tactical-mod.update','admin.campaign.advancement-tactical-mod.delete','admin.campaign.advancement-action.index','admin.campaign.advancement-action.edit','admin.campaign.advancement-action.create',
'admin.campaign.advancement-action.store','admin.campaign.advancement-action.update','admin.campaign.advancement-action.delete','admin.campaign.advancement-ability.index','admin.campaign.advancement-ability.edit',
'admin.campaign.advancement-ability.create','admin.campaign.advancement-ability.store','admin.campaign.advancement-ability.update','admin.campaign.advancement-ability.delete','tos.index',
'tos.compare','tos.search','tos.search.export','tos.search.save','tos.search.saved.delete',
'tos.allegiances.index','tos.allegiances.viewByType','tos.allegiances.view','tos.units.index','tos.units.pdf',
'tos.units.view','tos.units.commander','tos.units.titan','tos.units.fireteam','tos.units.squad',
'tos.units.champion','tos.packages.index','tos.packages.view','tos.special_rules.index','tos.abilities.index',
'tos.actions.index','tos.triggers.index','tos.allegiance_cards.index','tos.allegiance_cards.view','tos.assets.index',
'tos.assets.view','tos.stratagems.index','tos.stratagems.view','tos.collection.share','tos.collection.index',
'tos.collection.toggle','tos.collection.toggle_public','tos.collection.add_unit','tos.collection.add_units','tos.collection.update_status',
'tos.collection.update_status_bulk','tos.collection.remove_bulk','tos.collection.toggle_asset','tos.collection.update_asset_status','tos.companies.index',
'tos.companies.create','tos.companies.store','tos.companies.view','tos.companies.update','tos.companies.delete',
'tos.companies.toggle_public','tos.companies.set_garrison','tos.companies.pdf','tos.companies.units.add','tos.companies.units.remove',
'tos.companies.units.sculpt','tos.companies.assets.attach','tos.companies.assets.detach','tos.companies.stratagems.add','tos.companies.stratagems.remove',
'tos.companies.shared','tos.garrisons.index','tos.garrisons.create','tos.garrisons.store','tos.garrisons.view',
'tos.garrisons.update','tos.garrisons.delete','tos.garrisons.toggle_public','tos.garrisons.pdf','tos.garrisons.units.add',
'tos.garrisons.units.remove','tos.garrisons.units.sculpt','tos.garrisons.assets.attach','tos.garrisons.assets.detach','tos.garrisons.stratagems.pick',
'tos.garrisons.stratagems.unpick','tos.garrisons.envoys.pick','tos.garrisons.envoys.unpick','tos.garrisons.shared','system.switch',
'campaigns.preview','campaigns.invitations.show','campaigns.crews.arsenal.share','campaigns.join','campaigns.index',
'campaigns.create','campaigns.store','campaigns.show','campaigns.settings','campaigns.update',
'campaigns.start','campaigns.end','campaigns.destroy','campaigns.join-link.regenerate','campaigns.join-as-player',
'campaigns.invitations.store','campaigns.invitations.accept','campaigns.invitations.revoke','campaigns.crews.leader.edit','campaigns.crews.leader.update',
'campaigns.crews.leader.search.actions','campaigns.crews.leader.search.abilities','campaigns.crews.leader.advancements.store','campaigns.crews.leader.advancements.destroy','campaigns.crews.starting-arsenal.edit',
'campaigns.crews.starting-arsenal.update','campaigns.crews.arsenal.show','campaigns.crews.arsenal.models.store','campaigns.crews.arsenal.equipment.store','campaigns.weeks.advance',
'campaigns.crews.weekly-hire.edit','campaigns.crews.weekly-hire.update','campaigns.games.create','campaigns.games.store','campaigns.games.log',
'campaigns.games.log.store','campaigns.games.play','campaigns.crews.leader.annihilate','campaigns.crews.starting-anew','campaigns.crews.arsenal.scrap',
'campaigns.aftermaths.start','campaigns.aftermaths.show','campaigns.aftermaths.draw-hand','campaigns.aftermaths.payday','campaigns.aftermaths.barter',
'campaigns.aftermaths.advance','campaigns.aftermaths.back','campaigns.aftermaths.advance-leader','campaigns.aftermaths.doctor','campaigns.aftermaths.determine-injuries',
'campaigns.aftermaths.finalize','api.v1.characters.index','api.v1.characters.show','api.v1.keywords.index','api.v1.keywords.show',
'api.v1.upgrades.index','api.v1.upgrades.show','api.v1.actions.index','api.v1.actions.show','api.v1.abilities.index',
'api.v1.abilities.show','api.v1.triggers.index','api.v1.triggers.show','api.v1.markers.index','api.v1.markers.show',
'api.v1.tokens.index','api.v1.tokens.show','api.v1.strategies.index','api.v1.strategies.show','api.v1.schemes.index',
'api.v1.schemes.show','api.v1.terrains.index','api.v1.terrains.show','api.v1.channels.index','api.v1.channels.show',
'api.v1.transmissions.index','api.v1.transmissions.show','api.v1.packages.index','api.v1.packages.show','api.v1.blueprints.index',
'api.v1.blueprints.show','api.v1.characteristics.index','api.v1.characteristics.show','api.v1.miniatures.index','api.v1.miniatures.show',
'api.v1.factions.index','api.v1.factions.show','api.v1.crews.index','api.v1.crews.show','api.v1.games.index',
'api.v1.games.show','api.v1.lore.index','api.v1.lore.show','api.v1.lore_media.index','api.v1.lore_media.show',
'api.v1.tos.allegiances.index','api.v1.tos.allegiances.show','api.v1.tos.allegiance-cards.index','api.v1.tos.allegiance-cards.show','api.v1.tos.units.index',
'api.v1.tos.units.show','api.v1.tos.assets.index','api.v1.tos.assets.show','api.v1.tos.stratagems.index','api.v1.tos.stratagems.show',
'api.v1.tos.special_unit_rules.index','api.v1.tos.special_unit_rules.show','api.v1.tos.abilities.index','api.v1.tos.abilities.show','api.v1.tos.actions.index',
'api.v1.tos.actions.show','api.v1.tos.triggers.index','api.v1.tos.triggers.show','api.v1.tos.companies.index','api.v1.tos.companies.show',
'api.v1.tos.garrisons.index','api.v1.tos.garrisons.show','storage.local','scramble.docs.ui','scramble.docs.document',);
