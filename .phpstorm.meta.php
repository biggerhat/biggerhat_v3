...
'log-viewer.index','telescope','impersonate','impersonate.leave','sitemap',
'index','command','privacy','supporters.index','feedback.show',
'feedback.store','search.view','search.save','search.delete','search.export',
'characters.view','characters.random','characters.','characters.','keywords.index',
'keywords.view','markers.index','tokens.index','actions.index','triggers.index',
'abilities.index','factions.view','upgrades.crew.index','upgrades.character.index','upgrades.view',
'packages.index','packages.view','blueprints.index','lores.index','blog.index',
'blog.view','news.index','news.view','channels.index','channels.my',
'channels.view','transmissions.create','transmissions.store','transmissions.edit','transmissions.update',
'transmissions.delete','seasons.index','seasons.view','schemes.view','strategies.view',
'tools.hat_gamin','tools.pdf.index','tools.pdf.download','tools.scenario_generator','tools.scheme_paths',
'tools.random_character','tools.bonanza_loot_deck','tools.bonanza_loot_deck.print','tools.compare','tools.card_creator.share',
'tools.card_creator.upgrades.share','tools.card_creator.index','tools.card_creator.create','tools.card_creator.store','tools.card_creator.edit',
'tools.card_creator.update','tools.card_creator.destroy','tools.card_creator.upgrades.create','tools.card_creator.upgrades.store','tools.card_creator.upgrades.edit',
...
'campaigns.invitations.show','campaigns.crews.arsenal.share','campaigns.index','campaigns.create','campaigns.store',
'campaigns.show','campaigns.settings','campaigns.update','campaigns.start','campaigns.end',
'campaigns.destroy','campaigns.invitations.store','campaigns.invitations.accept','campaigns.invitations.revoke','campaigns.crews.leader.edit',
'campaigns.crews.leader.update','campaigns.crews.leader.search.actions','campaigns.crews.leader.search.abilities','campaigns.crews.leader.advancements.store','campaigns.crews.leader.advancements.destroy',
'campaigns.crews.starting-arsenal.edit','campaigns.crews.starting-arsenal.update','campaigns.crews.arsenal.show','campaigns.weeks.advance','campaigns.crews.weekly-hire.edit',
