...
'tos.collection.remove_bulk','tos.companies.index','tos.companies.create','tos.companies.store','tos.companies.view',
'tos.companies.update','tos.companies.delete','tos.companies.toggle_public','tos.companies.set_garrison','tos.companies.pdf',
'tos.companies.units.add','tos.companies.units.remove','tos.companies.units.sculpt','tos.companies.assets.attach','tos.companies.assets.detach',
'tos.companies.stratagems.add','tos.companies.stratagems.remove','tos.companies.shared','tos.garrisons.index','tos.garrisons.create',
'tos.garrisons.store','tos.garrisons.view','tos.garrisons.update','tos.garrisons.delete','tos.garrisons.toggle_public',
'tos.garrisons.pdf','tos.garrisons.units.add','tos.garrisons.units.remove','tos.garrisons.units.sculpt','tos.garrisons.assets.attach',
'tos.garrisons.assets.detach','tos.garrisons.stratagems.pick','tos.garrisons.stratagems.unpick','tos.garrisons.envoys.pick','tos.garrisons.envoys.unpick',
'tos.garrisons.shared','system.switch','campaigns.preview','campaigns.invitations.show','campaigns.crews.arsenal.share',
'campaigns.index','campaigns.create','campaigns.store','campaigns.show','campaigns.settings',
'campaigns.update','campaigns.start','campaigns.end','campaigns.destroy','campaigns.invitations.store',
...
'campaigns.games.store','campaigns.games.log','campaigns.games.log.store','campaigns.crews.leader.annihilate','campaigns.crews.starting-anew',
'campaigns.crews.arsenal.scrap','campaigns.aftermaths.start','campaigns.aftermaths.show','campaigns.aftermaths.draw-hand','campaigns.aftermaths.payday',
'campaigns.aftermaths.barter','campaigns.aftermaths.advance','campaigns.aftermaths.advance-leader','campaigns.aftermaths.doctor','campaigns.aftermaths.determine-injuries',
