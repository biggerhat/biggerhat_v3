...
'web','api',);
        registerArgumentsSet('routes', 'telescope','index','command','search.view','characters.view',
...
'tools.scenario_generator','tools.card_creator.share','tools.card_creator.index','tools.card_creator.create','tools.card_creator.store',
'tools.card_creator.edit','tools.card_creator.update','tools.card_creator.destroy','tools.card_creator.export','tools.crew_builder.index',
'tools.crew_builder.editor','tools.crew_builder.references','tools.crew_builder.share','tools.crew_builder.details','tools.crew_builder.store',
...
'games.join','games.index','games.create','games.store','games.show',
...
'games.play.crew.summon','games.play.crew.replace','games.play.soulstones','games.play.turns.store','games.play.complete',
'games.play.cancel_complete','tournaments.index','tournaments.view','tournaments.create','tournaments.store',
'tournaments.manage','tournaments.update','tournaments.destroy','tournaments.status','tournaments.organizers.add',
'tournaments.organizers.remove','tournaments.players.add','tournaments.players.update','tournaments.players.remove','tournaments.rounds.create',
'tournaments.rounds.update','tournaments.rounds.pair','tournaments.rounds.randomize','tournaments.games.create','tournaments.games.update',
...
'collection.update_status','collection.remove','api.characters.view','api.characters.search','api.characters.miniatures',
'api.','api.','api.','api.','api.',
'api.','api.','api.keywords.view','api.card-creator.actions','api.card-creator.abilities',
'api.card-creator.triggers','api.card-creator.keywords','api.blog.entity-search','api.blog.entity-show',
...
'admin.keywords.index','admin.keywords.edit','admin.keywords.create','admin.keywords.store','admin.keywords.update',
'admin.keywords.delete','admin.characteristics.index','admin.characteristics.edit','admin.characteristics.create','admin.characteristics.store',
'admin.characteristics.update','admin.characteristics.delete','admin.characters.index','admin.characters.edit','admin.characters.create',
'admin.characters.store','admin.characters.update','admin.characters.delete','admin.actions.index','admin.actions.edit',
'admin.actions.create','admin.actions.store','admin.actions.update','admin.actions.delete','admin.abilities.index',
'admin.abilities.edit','admin.abilities.create','admin.abilities.store','admin.abilities.update','admin.abilities.delete',
'admin.triggers.index','admin.triggers.edit','admin.triggers.create','admin.triggers.store','admin.triggers.update',
'admin.triggers.delete','admin.miniatures.index','admin.miniatures.edit','admin.miniatures.create','admin.miniatures.store',
'admin.miniatures.update','admin.miniatures.delete','admin.upgrades.index','admin.upgrades.edit','admin.upgrades.create',
'admin.upgrades.store','admin.upgrades.update','admin.upgrades.delete','admin.crews.index','admin.crews.edit',
'admin.crews.create','admin.crews.store','admin.crews.update','admin.crews.delete','admin.tokens.index',
'admin.tokens.edit','admin.tokens.create','admin.tokens.store','admin.tokens.update','admin.tokens.delete',
'admin.markers.index','admin.markers.edit','admin.markers.create','admin.markers.store','admin.markers.update',
'admin.markers.delete','admin.schemes.index','admin.schemes.edit','admin.schemes.create','admin.schemes.store',
'admin.schemes.update','admin.schemes.delete','admin.strategies.index','admin.strategies.edit','admin.strategies.create',
'admin.strategies.store','admin.strategies.update','admin.strategies.delete','admin.roles.index','admin.roles.edit',
'admin.roles.create','admin.roles.store','admin.roles.update','admin.roles.delete','admin.users.index',
'admin.users.edit','admin.users.update','admin.users.password_reset_link','admin.users.delete','admin.packages.index',
'admin.packages.edit','admin.packages.create','admin.packages.store','admin.packages.update','admin.packages.delete',
'admin.lore_media.index','admin.lore_media.edit','admin.lore_media.create','admin.lore_media.store','admin.lore_media.update',
'admin.lore_media.delete','admin.lores.index','admin.lores.edit','admin.lores.create','admin.lores.store',
'admin.lores.update','admin.lores.delete','admin.blueprints.index','admin.blueprints.edit','admin.blueprints.create',
'admin.blueprints.store','admin.blueprints.update','admin.blueprints.delete','admin.channels.index','admin.channels.edit',
'admin.channels.create','admin.channels.store','admin.channels.update','admin.channels.delete','admin.transmissions.index',
'admin.transmissions.edit','admin.transmissions.create','admin.transmissions.store','admin.transmissions.update','admin.transmissions.delete',
'admin.blog.categories.index','admin.blog.categories.edit','admin.blog.categories.create','admin.blog.categories.store','admin.blog.categories.update',
'admin.blog.categories.delete','admin.blog.posts.index','admin.blog.posts.preview','admin.blog.posts.edit','admin.blog.posts.create',
'admin.blog.posts.store','admin.blog.posts.update','admin.blog.posts.delete','api.v1.characters.index','api.v1.characters.show',
...
'api.v1.miniatures.index','api.v1.miniatures.show','api.v1.factions.index','api.v1.factions.show','storage.local',
