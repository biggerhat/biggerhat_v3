...
'tools.scenario_generator','tools.scheme_paths','tools.random_character','tools.bonanza_loot_deck','tools.compare',
'tools.card_creator.share','tools.card_creator.upgrades.share','tools.card_creator.index','tools.card_creator.create','tools.card_creator.store',
'tools.card_creator.edit','tools.card_creator.update','tools.card_creator.destroy','tools.card_creator.upgrades.create','tools.card_creator.upgrades.store',
'tools.card_creator.upgrades.edit','tools.card_creator.upgrades.update','tools.card_creator.upgrades.destroy','tools.crew_builder.index','tools.crew_builder.editor',
...
'games.setup.crew','games.setup.crew.skip','games.setup.scheme','games.setup.swap_roles','games.setup.opponent_name',
'games.play.crew.update','games.play.crew.kill','games.play.crew.revive','games.play.crew.summon','games.play.crew.replace',
'games.play.soulstones','games.play.crew-upgrade','games.play.crew-upgrade-power-bar','games.play.bonanza_vp','games.play.bonanza_next_turn',
'games.play.loot.draw','games.play.loot.select','games.play.loot.attach','games.play.loot.yoink','games.play.scheme-notes',
'games.play.turns.store','games.play.turns.edit','games.play.complete','games.play.cancel_complete','metas.index',
'metas.store','tournaments.index','tournaments.view','tournaments.create','tournaments.store',
'tournaments.manage','tournaments.update','tournaments.destroy','tournaments.status','tournaments.organizers.add',
'tournaments.organizers.remove','tournaments.rsvp','tournaments.rsvp.cancel','tournaments.users.search','tournaments.players.add',
'tournaments.players.update','tournaments.players.remove','tournaments.rounds.create','tournaments.rounds.generate_all','tournaments.rounds.update',
'tournaments.rounds.delete','tournaments.rounds.pair','tournaments.rounds.randomize','tournaments.games.create','tournaments.games.update',
'tournaments.games.delete','tournaments.games.forfeit','tournaments.games.complete_tracker','tournaments.export_csv','collection.share',
'collection.index','collection.toggle','collection.toggle_public','collection.add_character','collection.add_characters',
'collection.add_package','collection.toggle_package','collection.update_status','collection.update_status_bulk','collection.remove',
'collection.remove_bulk','api.characters.view','api.characters.search','api.characters.compare','api.characters.miniatures',
'api.','api.','api.','api.','api.',
'api.','api.','api.keywords.view','api.card-creator.actions','api.card-creator.abilities',
'api.card-creator.triggers','api.card-creator.keywords','api.card-creator.crew-upgrades','api.card-creator.characters','api.card-creator.tokens',
'api.card-creator.markers','api.card-creator.character-detail','api.blog.posts.index','api.blog.entity-search','api.blog.entity-show','profile.edit','profile.update','profile.destroy','password.edit',
...
'logout','admin.dashboard','admin.refresh_analytics','admin.activity.index','admin.loot_cards.index',
'admin.loot_cards.create','admin.loot_cards.store','admin.loot_cards.edit','admin.loot_cards.update','admin.loot_cards.destroy',
...
'admin.tos.stratagems.create','admin.tos.stratagems.store','admin.tos.stratagems.update','admin.tos.stratagems.delete','admin.campaign.leader-archetypes.index',
'admin.campaign.leader-archetypes.edit','admin.campaign.leader-archetypes.create','admin.campaign.leader-archetypes.store','admin.campaign.leader-archetypes.update','admin.campaign.leader-archetypes.delete',
'admin.campaign.crew-card-effects.index','admin.campaign.crew-card-effects.edit','admin.campaign.crew-card-effects.create','admin.campaign.crew-card-effects.store','admin.campaign.crew-card-effects.update',
'admin.campaign.crew-card-effects.delete','admin.campaign.equipment.index','admin.campaign.equipment.edit','admin.campaign.equipment.create','admin.campaign.equipment.store',
'admin.campaign.equipment.update','admin.campaign.equipment.delete','admin.campaign.injuries.index','admin.campaign.injuries.edit','admin.campaign.injuries.create',
'admin.campaign.injuries.store','admin.campaign.injuries.update','admin.campaign.injuries.delete','admin.campaign.lucky-miss.index','admin.campaign.lucky-miss.edit',
...
'admin.campaign.advancement-ability.create','admin.campaign.advancement-ability.store','admin.campaign.advancement-ability.update','admin.campaign.advancement-ability.delete','admin.campaign.totems.index',
'admin.campaign.totems.edit','admin.campaign.totems.create','admin.campaign.totems.store','admin.campaign.totems.update','admin.campaign.totems.delete',
'admin.campaign.summoning-advancements.index','admin.campaign.summoning-advancements.edit','admin.campaign.summoning-advancements.create','admin.campaign.summoning-advancements.store','admin.campaign.summoning-advancements.update',
'admin.campaign.summoning-advancements.delete','admin.campaign.weekly-events.index','admin.campaign.weekly-events.edit','admin.campaign.weekly-events.create','admin.campaign.weekly-events.store',
'admin.campaign.weekly-events.update','admin.campaign.weekly-events.delete','tos.index','tos.compare','tos.search',
...
'tos.companies.units.sculpt','tos.companies.assets.attach','tos.companies.assets.detach','tos.companies.shared','tos.garrisons.index',
'tos.garrisons.create','tos.garrisons.store','tos.garrisons.view','tos.garrisons.update','tos.garrisons.delete',
'tos.garrisons.toggle_public','tos.garrisons.pdf','tos.garrisons.units.add','tos.garrisons.units.remove','tos.garrisons.units.sculpt',
'tos.garrisons.assets.attach','tos.garrisons.assets.detach','tos.garrisons.stratagems.pick','tos.garrisons.stratagems.unpick','tos.garrisons.envoys.pick',
'tos.garrisons.envoys.unpick','tos.garrisons.shared','system.switch','campaigns.invitations.show','campaigns.index',
...
'campaigns.invitations.revoke','api.v1.characters.index','api.v1.characters.show','api.v1.keywords.index','api.v1.keywords.show',
...
'api.v1.tos.actions.show','api.v1.tos.triggers.index','api.v1.tos.triggers.show','storage.local','scramble.docs.ui',
'scramble.docs.document',);
        registerArgumentsSet('views', 
'PDF.CharacterImageBlank','PDF.Company','PDF.Garrison','app','laravel-exceptions-renderer::components.card',
...
'scramble::docs','telescope::layout',);
...
'MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS','ANALYTICS_PROPERTY_ID','REVERB_APP_ID','REVERB_APP_KEY',
