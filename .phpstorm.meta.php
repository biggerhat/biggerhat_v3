...
'campaigns.crews.arsenal.show','campaigns.weeks.advance','campaigns.crews.weekly-hire.edit','campaigns.crews.weekly-hire.update','campaigns.games.create',
'campaigns.games.store','campaigns.games.log','campaigns.games.log.store','campaigns.games.play','campaigns.crews.leader.annihilate',
'campaigns.crews.starting-anew','campaigns.crews.arsenal.scrap','campaigns.aftermaths.start','campaigns.aftermaths.show','campaigns.aftermaths.draw-hand',
'campaigns.aftermaths.payday','campaigns.aftermaths.barter','campaigns.aftermaths.advance','campaigns.aftermaths.back','campaigns.aftermaths.advance-leader',
'campaigns.aftermaths.doctor','campaigns.aftermaths.determine-injuries','campaigns.aftermaths.finalize','api.v1.characters.index','api.v1.characters.show',
'api.v1.keywords.index','api.v1.keywords.show','api.v1.upgrades.index','api.v1.upgrades.show','api.v1.actions.index',
'api.v1.actions.show','api.v1.abilities.index','api.v1.abilities.show','api.v1.triggers.index','api.v1.triggers.show',
'api.v1.markers.index','api.v1.markers.show','api.v1.tokens.index','api.v1.tokens.show','api.v1.strategies.index',
'api.v1.strategies.show','api.v1.schemes.index','api.v1.schemes.show','api.v1.terrains.index','api.v1.terrains.show',
'api.v1.channels.index','api.v1.channels.show','api.v1.transmissions.index','api.v1.transmissions.show','api.v1.packages.index',
'api.v1.packages.show','api.v1.blueprints.index','api.v1.blueprints.show','api.v1.characteristics.index','api.v1.characteristics.show',
'api.v1.miniatures.index','api.v1.miniatures.show','api.v1.factions.index','api.v1.factions.show','api.v1.crews.index',
'api.v1.crews.show','api.v1.games.index','api.v1.games.show','api.v1.lore.index','api.v1.lore.show',
'api.v1.lore_media.index','api.v1.lore_media.show','api.v1.tos.allegiances.index','api.v1.tos.allegiances.show','api.v1.tos.allegiance-cards.index',
'api.v1.tos.allegiance-cards.show','api.v1.tos.units.index','api.v1.tos.units.show','api.v1.tos.assets.index','api.v1.tos.assets.show',
'api.v1.tos.stratagems.index','api.v1.tos.stratagems.show','api.v1.tos.special_unit_rules.index','api.v1.tos.special_unit_rules.show','api.v1.tos.abilities.index',
'api.v1.tos.abilities.show','api.v1.tos.actions.index','api.v1.tos.actions.show','api.v1.tos.triggers.index','api.v1.tos.triggers.show',
'api.v1.tos.companies.index','api.v1.tos.companies.show','api.v1.tos.garrisons.index','api.v1.tos.garrisons.show','storage.local',
