...
'tools.compare','tools.card_creator.share','tools.card_creator.upgrades.share','tools.card_creator.index','tools.card_creator.create',
'tools.card_creator.store','tools.card_creator.edit','tools.card_creator.update','tools.card_creator.destroy','tools.card_creator.upgrades.create',
'tools.card_creator.upgrades.store','tools.card_creator.upgrades.edit','tools.card_creator.upgrades.update','tools.card_creator.upgrades.destroy','tools.crew_builder.index',
...
'api.card-creator.character-detail','api.blog.posts.index','api.blog.entity-search','api.blog.entity-show',
...
'admin.blog.posts.update','admin.blog.posts.delete','admin.blog.posts.upload-image','admin.feedback.index','admin.feedback.update',
'admin.feedback.delete','admin.pod_links.index','admin.pod_links.edit','admin.pod_links.create','admin.pod_links.store',
'admin.pod_links.update','admin.pod_links.delete','admin.tos.allegiances.index','admin.tos.allegiances.edit','admin.tos.allegiances.create',
'admin.tos.allegiances.store','admin.tos.allegiances.update','admin.tos.allegiances.delete','admin.tos.units.index','admin.tos.units.edit',
'admin.tos.units.create','admin.tos.units.store','admin.tos.units.update','admin.tos.units.delete','admin.tos.sculpts.index',
'admin.tos.sculpts.edit','admin.tos.sculpts.create','admin.tos.sculpts.store','admin.tos.sculpts.update','admin.tos.sculpts.delete',
'admin.tos.abilities.index','admin.tos.abilities.edit','admin.tos.abilities.create','admin.tos.abilities.store','admin.tos.abilities.update',
'admin.tos.abilities.delete','admin.tos.actions.index','admin.tos.actions.edit','admin.tos.actions.create','admin.tos.actions.store',
'admin.tos.actions.update','admin.tos.actions.delete','admin.tos.triggers.index','admin.tos.triggers.edit','admin.tos.triggers.create',
'admin.tos.triggers.store','admin.tos.triggers.update','admin.tos.triggers.delete','admin.tos.special_rules.index','admin.tos.special_rules.edit',
'admin.tos.special_rules.create','admin.tos.special_rules.store','admin.tos.special_rules.update','admin.tos.special_rules.delete','admin.tos.allegiance_cards.index',
'admin.tos.allegiance_cards.edit','admin.tos.allegiance_cards.create','admin.tos.allegiance_cards.store','admin.tos.allegiance_cards.update','admin.tos.allegiance_cards.delete',
'admin.tos.assets.index','admin.tos.assets.edit','admin.tos.assets.create','admin.tos.assets.store','admin.tos.assets.update',
'admin.tos.assets.delete','admin.tos.stratagems.index','admin.tos.stratagems.edit','admin.tos.stratagems.create','admin.tos.stratagems.store',
'admin.tos.stratagems.update','admin.tos.stratagems.delete','admin.campaign.crew-cards.index','admin.campaign.crew-cards.edit','admin.campaign.crew-cards.create',
'admin.campaign.crew-cards.store','admin.campaign.crew-cards.update','admin.campaign.crew-cards.delete','admin.campaign.totem-templates.index','admin.campaign.totem-templates.edit',
'admin.campaign.totem-templates.create','admin.campaign.totem-templates.store','admin.campaign.totem-templates.update','admin.campaign.totem-templates.delete','admin.campaign.lucky-miss.index',
'admin.campaign.lucky-miss.edit','admin.campaign.lucky-miss.create','admin.campaign.lucky-miss.store','admin.campaign.lucky-miss.update','admin.campaign.lucky-miss.delete',
'admin.campaign.back-alley-doctor.index','admin.campaign.back-alley-doctor.edit','admin.campaign.back-alley-doctor.create','admin.campaign.back-alley-doctor.store','admin.campaign.back-alley-doctor.update',
'admin.campaign.back-alley-doctor.delete','admin.campaign.weekly-events.index','admin.campaign.weekly-events.edit','admin.campaign.weekly-events.create','admin.campaign.weekly-events.store',
'admin.campaign.weekly-events.update','admin.campaign.weekly-events.delete','admin.campaign.advancement-attack-mod.index','admin.campaign.advancement-attack-mod.edit','admin.campaign.advancement-attack-mod.create',
'admin.campaign.advancement-attack-mod.store','admin.campaign.advancement-attack-mod.update','admin.campaign.advancement-attack-mod.delete','admin.campaign.advancement-tactical-mod.index','admin.campaign.advancement-tactical-mod.edit',
'admin.campaign.advancement-tactical-mod.create','admin.campaign.advancement-tactical-mod.store','admin.campaign.advancement-tactical-mod.update','admin.campaign.advancement-tactical-mod.delete','admin.campaign.advancement-action.index',
'admin.campaign.advancement-action.edit','admin.campaign.advancement-action.create','admin.campaign.advancement-action.store','admin.campaign.advancement-action.update','admin.campaign.advancement-action.delete',
'admin.campaign.advancement-ability.index','admin.campaign.advancement-ability.edit','admin.campaign.advancement-ability.create','admin.campaign.advancement-ability.store','admin.campaign.advancement-ability.update',
'admin.campaign.advancement-ability.delete','tos.index','tos.compare','tos.search','tos.search.export',
'tos.search.save','tos.search.saved.delete','tos.allegiances.index','tos.allegiances.viewByType','tos.allegiances.view',
'tos.units.index','tos.units.pdf','tos.units.view','tos.units.commander','tos.units.titan',
'tos.units.fireteam','tos.units.squad','tos.units.champion','tos.special_rules.index','tos.abilities.index',
'tos.actions.index','tos.triggers.index','tos.allegiance_cards.index','tos.allegiance_cards.view','tos.assets.index',
'tos.assets.view','tos.stratagems.index','tos.stratagems.view','tos.companies.index','tos.companies.create',
