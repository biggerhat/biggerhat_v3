...
'tools.scenario_generator','tools.compare','tools.card_creator.share','tools.card_creator.upgrades.share','tools.card_creator.index',
'tools.card_creator.create','tools.card_creator.store','tools.card_creator.edit','tools.card_creator.update','tools.card_creator.destroy',
'tools.card_creator.upgrades.create','tools.card_creator.upgrades.store','tools.card_creator.upgrades.edit','tools.card_creator.upgrades.update','tools.card_creator.upgrades.destroy',
'tools.crew_builder.index','tools.crew_builder.editor','tools.crew_builder.references','tools.crew_builder.share','tools.crew_builder.quick_ref',
'tools.crew_builder.details','tools.crew_builder.store','tools.crew_builder.update','tools.crew_builder.destroy','wishlists.share',
'wishlists.index','wishlists.store','wishlists.show','wishlists.update','wishlists.destroy',
'wishlists.items.add','wishlists.items.remove','wishlists.add_keyword','wishlists.toggle_public','games.public',
'games.observe','games.summary','games.join','stats.my','stats.show',
'games.index','games.create','games.store','games.show','games.scenario.update',
'games.scenario.regenerate','games.destroy','games.abandon','games.toggle_observable','games.settings.update',
'games.setup.faction','games.setup.master','games.setup.crew','games.setup.crew.skip','games.setup.scheme',
...
'games.play.scheme-notes','games.play.turns.store','games.play.complete','games.play.cancel_complete','metas.index',
...
'collection.add_package','collection.toggle_package','collection.update_status','collection.remove','api.characters.view',
...
'admin.refresh_analytics','admin.activity.index','admin.failed_jobs.index','admin.failed_jobs.retry_all','admin.failed_jobs.flush',
...
'admin.tos.stratagems.delete','tos.index','tos.compare','tos.search','tos.search.export',
...
'tos.companies.assets.attach','tos.companies.assets.detach','tos.companies.shared','tos.garrisons.index','tos.garrisons.create',
...
'tos.garrisons.shared','system.switch','api.v1.characters.index','api.v1.characters.show','api.v1.keywords.index',
'api.v1.keywords.show','api.v1.upgrades.index','api.v1.upgrades.show','api.v1.actions.index','api.v1.actions.show',
'api.v1.abilities.index','api.v1.abilities.show','api.v1.triggers.index','api.v1.triggers.show','api.v1.markers.index',
'api.v1.markers.show','api.v1.tokens.index','api.v1.tokens.show','api.v1.strategies.index','api.v1.strategies.show',
'api.v1.schemes.index','api.v1.schemes.show','api.v1.terrains.index','api.v1.terrains.show','api.v1.channels.index',
'api.v1.channels.show','api.v1.transmissions.index','api.v1.transmissions.show','api.v1.packages.index','api.v1.packages.show',
'api.v1.blueprints.index','api.v1.blueprints.show','api.v1.characteristics.index','api.v1.characteristics.show','api.v1.miniatures.index',
'api.v1.miniatures.show','api.v1.factions.index','api.v1.factions.show','api.v1.crews.index','api.v1.crews.show',
'api.v1.games.index','api.v1.games.show','api.v1.lore.index','api.v1.lore.show','api.v1.lore_media.index',
'api.v1.lore_media.show','api.v1.tos.allegiances.index','api.v1.tos.allegiances.show','api.v1.tos.allegiance-cards.index','api.v1.tos.allegiance-cards.show',
'api.v1.tos.units.index','api.v1.tos.units.show','api.v1.tos.assets.index','api.v1.tos.assets.show','api.v1.tos.stratagems.index',
'api.v1.tos.stratagems.show','api.v1.tos.special_unit_rules.index','api.v1.tos.special_unit_rules.show','api.v1.tos.abilities.index','api.v1.tos.abilities.show',
'api.v1.tos.actions.index','api.v1.tos.actions.show','api.v1.tos.triggers.index','api.v1.tos.triggers.show','storage.local',
