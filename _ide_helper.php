...
namespace Illuminate\Http {
    ...
    class RedirectResponse {
         ...
         * @static 
         */
        public static function withMessage($message, $messageTitle = null, $messageType = \App\Enums\MessageTypeEnum::success)
        {
...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
         ...
         * @static 
         */
        public static function dropForeignSafe($args)
        {
            return \Illuminate\Database\Schema\Blueprint::dropForeignSafe($args);
        }
