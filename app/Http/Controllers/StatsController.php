...
class StatsController extends Controller
{
    ...
    private function buildProfile(User $user, int $totalGames, int $wins, array $factionStats): array
    {
        ...
        $tournamentsPlayed = $tournamentRecord['played'];
        $bestFinish = $tournamentRecord['best_finish'];
        ...
        // Achievement badges
        $badges = $this->achievements->computeBadges($totalGames, $wins, $collectionTotal, $collectionBuilt, $collectionPainted, $tournamentsPlayed, $bestFinish, $publicCrews);
