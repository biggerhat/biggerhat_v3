...
class UpdateLeaderArchetypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'slug' => [
                'required', 'string', Rule::enum(LeaderArchetypeEnum::class),
                Rule::unique('leader_archetypes', 'slug')->ignore($this->route('archetype')?->id),
            ],
