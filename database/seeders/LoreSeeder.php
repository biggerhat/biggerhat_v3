...
class LoreSeeder extends Seeder
{
    ...
    {
        $media = [
            ['name' => 'Malifaux Core Rulebook (M3E)', 'type' => LoreMediaTypeEnum::Rulebook, 'link' => 'https://www.wyrd-games.net/malifaux'],
            ['name' => 'Malifaux Burns', 'type' => LoreMediaTypeEnum::FactionBook, 'link' => 'https://www.wyrd-games.net/malifaux'],
            ...
            ['name' => 'The Other Side Core Rulebook', 'type' => LoreMediaTypeEnum::Rulebook, 'link' => 'https://www.wyrd-games.net/the-other-side'],
            ['name' => 'Chronicles Volume 1', 'type' => LoreMediaTypeEnum::Chronicle, 'link' => 'https://www.wyrd-games.net/chronicle'],
            ['name' => 'Chronicles Volume 2', 'type' => LoreMediaTypeEnum::Chronicle, 'link' => 'https://www.wyrd-games.net/chronicle'],
            ...
            ['name' => 'Wyrd News - January 2024', 'type' => LoreMediaTypeEnum::WyrdNews, 'link' => 'https://www.wyrd-games.net/news'],
            ['name' => 'Wyrd News - March 2024', 'type' => LoreMediaTypeEnum::WyrdNews, 'link' => 'https://www.wyrd-games.net/news'],
            ...
            ['name' => 'Book 5: Crossroads', 'type' => LoreMediaTypeEnum::FactionBook, 'link' => null],
        ];
    ...
    private function seedLore(): void
    {
        ...
        $lores = [
            ...
            [
                ...
                'media' => ['Malifaux Core Rulebook (M3E)', 'Chronicles Volume 1'],
                'characters' => ['Lady Justice', 'Perdita Ortega'],
            ],
            [
                'name' => 'Burning of Malifaux',
                'media' => ['Malifaux Burns', 'Wyrd News - January 2024'],
            ...
            [
                'name' => 'Bayou Troubles',
                'media' => ['Bayou Broadcast #1', 'Ripples of Fate'],
                'characters' => ['Som\'er Teeth Jones', 'Ophelia LaCroix'],
            ],
            [
                'name' => 'The Redchapel Killer',
                'media' => ['Malifaux Core Rulebook (M3E)', 'Book 1: Rising Powers'],
                'characters' => ['Seamus'],
            ],
            [
            ...
            [
                ...
                'media' => ['Malifaux Core Rulebook (M3E)', 'Malifaux Madness'],
                'characters' => ['Pandora', 'Lilith'],
            ],
            [
                'name' => 'The Plague Spreads',
                'media' => ['Malifaux Burns', 'Broken Promises'],
                'characters' => ['Hamelin'],
            ],
            [
            ...
            [
                ...
                'media' => ['Broken Promises', 'Chronicles Volume 2'],
            ...
            [
                ...
                'media' => ['Shifting Loyalties', 'Book 5: Crossroads'],
                'characters' => ['Tara', 'Jack Daw'],
            ],
            [
                'name' => 'The Explorer\'s Society Founded',
                'media' => ['Malifaux Burns', 'Wyrd News - March 2024'],
            ...
            [
                ...
                'media' => ['Malifaux Madness', 'Malifaux Core Rulebook (M3E)'],
            ...
            [
                ...
                'media' => ['The Other Side Core Rulebook', 'Malifaux Burns'],
                'characters' => ['Kaeris'],
            ],
            [
                'name' => 'Perdita\'s Hunt',
        ...
        foreach ($lores as $data) {
            $mediaIds = collect($data['media'])
                ->map(fn ($name) => $mediaByName[$name] ?? null)
                ->filter()
                ->pluck('id');
