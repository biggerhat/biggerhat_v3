...
defineProps<{
    open: boolean;
    /** Member being replaced; shown in the description. */
    member: ReplaceTarget | null;
        ...
        <DialogContent class="max-w-sm">
            <DialogHeader>
                ...
                <DialogDescription v-if="member">
                    Replacing <strong>{{ member.display_name }}</strong> ({{ member.current_health }}/{{ member.max_health }} HP)
                </DialogDescription>
            </DialogHeader>
