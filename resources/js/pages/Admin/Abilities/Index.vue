...
const columns: ColumnDef<Abilities>[] = [
    {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'relative' }, h(AdminActions, { name: ability.name, editRoute: route('admin.abilities.edit', ability.slug), deleteRoute: route('admin.abilities.delete', ability.slug) }))
        },
    },
];
