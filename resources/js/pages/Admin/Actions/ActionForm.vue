...
const formInfo = ref({
    ...
    triggers: [],
    characters: [],
    // Campaign-only field — surfaced when game_mode_type === 'campaign'.
    // 'summoning' is the only remaining shared-catalog kind (Action
    // advancement now lives on its own dedicated table).
    campaign_advancement_kind: null as string | null,
});
                        ...
                        >
                            ...
                            <div class="flex flex-col space-y-1.5">
                                ...
                                <Select id="campaign_advancement_kind" v-model="formInfo.campaign_advancement_kind">
                                    <SelectTrigger>
                                        <SelectValue placeholder="Summoning" />
                                    </SelectTrigger>
                                    <SelectContent>
