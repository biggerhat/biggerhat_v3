...
const columns: ColumnDef<Characteristics>[] = [
    {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'relative' }, h(AdminActions, { name: action.name, editRoute: route('admin.actions.edit', action.slug), deleteRoute: route('admin.actions.delete', action.slug) }))
        },
    },
];
