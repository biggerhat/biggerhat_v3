...
onMounted(() => {
    formInfo.value.name = props.category?.name ?? null;
    formInfo.value.description = props.category?.description ?? null;
});
</script>
                ...
                <form>
                    <div class="grid w-full items-center gap-4">
                        <div class="flex flex-col space-y-1.5">
                            ...
                            <Input id="name" v-model="formInfo.name" placeholder="Category Name" />
                            <InputError :message="usePage().props.errors.name" />
                        </div>
                        <div class="flex flex-col space-y-1.5">
                            <Label for="description">Description</Label>
                            <Textarea id="description" v-model="formInfo.description" placeholder="Type the category description here." />
