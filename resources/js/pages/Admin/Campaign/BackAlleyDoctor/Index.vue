...
<template>
    ...
    <PageBanner title="Back-Alley Doctor Results" class="mb-2">
        <template #subtitle>
            <div class="my-auto px-2 py-0 text-xs text-muted-foreground md:py-2 md:text-sm md:text-foreground">
                Pg 33. Outcomes for the Phase 5 injury-removal flip.
            </div>
        </template>
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.campaign.back-alley-doctor.create'))">Create</Button>
        </template>
    </PageBanner>
