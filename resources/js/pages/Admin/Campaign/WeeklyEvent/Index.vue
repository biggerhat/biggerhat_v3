...
<template>
    ...
    <PageBanner title="Weekly Events" class="mb-2">
        <template #subtitle>
            <div class="my-auto px-2 py-0 text-xs text-muted-foreground md:py-2 md:text-sm md:text-foreground">
                Pg 148–149. Rolled at week start when weekly events are enabled.
            </div>
        </template>
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.campaign.weekly-events.create'))">Create</Button>
        </template>
    </PageBanner>
