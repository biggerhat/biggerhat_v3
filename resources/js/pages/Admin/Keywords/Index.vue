...
const columns: ColumnDef<Keywords>[] = [
    {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'relative' }, h(AdminActions, { name: keyword.name, editRoute: route('admin.keywords.edit', keyword.slug), deleteRoute: route('admin.keywords.delete', keyword.slug) }))
        },
    },
];
