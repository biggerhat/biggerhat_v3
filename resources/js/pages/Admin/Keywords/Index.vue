    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return h(
                ...
                h(AdminActions, {
                    name: keyword.name,
                    editRoute: route('admin.keywords.edit', keyword.slug),
                    deleteRoute: route('admin.keywords.delete', keyword.slug),
                }),
            );
        },
    },
...
<template>
    ...
    <PageBanner title="Keywords" class="mb-2">
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.keywords.create'))"> Create New Keyword </Button>
        </template>
    </PageBanner>
