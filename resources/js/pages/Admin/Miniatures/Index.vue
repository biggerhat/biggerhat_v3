        ...
        cell: ({ row }) => {
            ...
            return h(
                ...
                h(AdminActions, {
                    ...
                    editRoute: route('admin.miniatures.edit', miniature.id),
                    deleteRoute: route('admin.miniatures.delete', miniature.id),
                }),
            );
        },
    },
...
<template>
    ...
    <PageBanner title="Miniatures" class="mb-2">
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.miniatures.create'))"> Create New Miniature </Button>
        </template>
    </PageBanner>
