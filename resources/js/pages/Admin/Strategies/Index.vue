...
<template>
    <Head title="Strategies - Admin" />

    <PageBanner title="Strategies" class="mb-2">
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.strategies.create'))"> Create New Strategy </Button>
        </template>
    </PageBanner>
