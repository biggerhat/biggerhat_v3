...
<template>
    ...
    <PageBanner title="TOS Allegiance Cards" class="mb-2">
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.tos.allegiance_cards.create'))">Create Allegiance Card</Button>
        </template>
    </PageBanner>
