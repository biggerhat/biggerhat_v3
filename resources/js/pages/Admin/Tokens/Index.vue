    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return h(
                ...
                h(AdminActions, {
                    name: token.name,
                    editRoute: route('admin.tokens.edit', token.slug),
                    deleteRoute: route('admin.tokens.delete', token.slug),
                }),
            );
        },
    },
...
<template>
    ...
    <PageBanner title="Tokens" class="mb-2">
        <template #actions>
            <Button class="my-auto mr-2" @click="router.get(route('admin.tokens.create'))"> Create New Token </Button>
        </template>
    </PageBanner>
