...
const columns: ColumnDef<Triggers>[] = [
    {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { class: 'relative' }, h(AdminActions, { name: trigger.name, editRoute: route('admin.triggers.edit', trigger.slug), deleteRoute: route('admin.triggers.delete', trigger.slug) }))
        },
    },
];
