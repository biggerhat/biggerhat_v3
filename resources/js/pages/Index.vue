        ...
        <div class="container mx-auto flex flex-col gap-8 p-4">
            ...
            <div class="animate-fade-in-up grid grid-cols-4 gap-3 md:grid-cols-8" style="animation-delay: 100ms">
                <Link
                    ...
                    class="flex flex-col items-center gap-2 rounded-lg p-3 transition-all duration-200 hover:-translate-y-1 hover:scale-105 hover:bg-muted"
                >
            ...
            <div class="animate-fade-in-up grid gap-3 md:grid-cols-2" style="animation-delay: 300ms">
                <Link
                    ...
                    class="flex items-center gap-3 rounded-lg border p-4 transition-all duration-200 hover:-translate-y-1 hover:border-primary hover:shadow-xl"
                >
