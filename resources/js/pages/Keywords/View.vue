...
<template>
    ...
    <div class="relative">
        ...
        <!-- Stats Block -->
        <div v-if="hasStats && !isLoading" class="container mx-auto mb-4 sm:px-4">
        ...
        <div v-else-if="isLoading" class="container mx-auto mt-4 items-center sm:px-4">
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                <CardSkeleton v-for="n in 8" :key="`skeleton-${n}`" />
            </div>
        </div>
        <div v-else-if="filterParams.page_view === 'keyword_breakdown'" class="container mx-auto items-center sm:px-4">
            <template v-if="props.keyword_breakdown">
                <KeywordBreakdown :keyword="props.keyword_breakdown" />
            </template>
            <EmptyState v-else />
        </div>
        <div v-else-if="filterParams.page_view === 'table'" class="container mx-auto items-center overflow-auto sm:px-4">
            <CharacterTable :characters="props.characters" />
        </div>
        <div v-else-if="filterParams.page_view === 'full'" class="container mx-auto items-center sm:px-4">
