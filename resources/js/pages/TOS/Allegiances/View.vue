    ...
    <div class="relative">
                ...
                <div class="flex flex-wrap items-center gap-x-3 gap-y-2 sm:gap-x-5">
                    ...
                    <div v-if="statistics.average_scrip != null" class="flex items-center gap-3">
                        <div class="text-center">
                            ...
                            <div class="text-sm font-bold tabular-nums leading-tight">{{ statistics.average_scrip }}</div>
                        </div>
                        <div class="text-center">
                            <div class="text-[10px] font-medium uppercase tracking-wide text-muted-foreground">Total Scrip</div>
                            <div class="text-sm font-bold tabular-nums leading-tight">{{ statistics.total_scrip }}</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sticky top-0 z-20 mb-2 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
            <div class="container mx-auto flex flex-wrap items-center justify-between gap-2 py-2 sm:px-4">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <Tabs v-if="showViewToggle" :model-value="filterParams.page_view" @update:model-value="(v) => handleViewChange(v as string)">
                        <TabsList>
        ...
        <div class="container mx-auto sm:px-4">
            ...
            <div class="flex gap-6">
                ...
                <aside v-if="showUnitFilters || filterParams.resource_type === 'all'" class="hidden w-56 shrink-0 md:block lg:w-72">
                ...
                <div class="min-w-0 flex-1 space-y-6">
                    ...
                    <template v-else>
                        ...
                        <section v-if="showUnits">
                            ...
                            <div v-else-if="units.length" class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
                                <Card
                                    v-for="u in units"
                                    :key="u.id"
                                ...
                                >
                                    ...
                                    <CardContent class="space-y-1.5 p-3">
                                        ...
                                        <div class="flex flex-wrap gap-1">
                                            ...
                                            <Badge v-for="r in u.special_unit_rules" :key="r.id" variant="outline" class="text-[10px]">{{
                                                r.name
                                            }}</Badge>
                                        </div>
