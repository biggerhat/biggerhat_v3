...
Route::prefix('games')->name('games.')->middleware('auth')->group(function () {
    ...
    Route::prefix('/{game:uuid}/setup')->name('setup.')->group(function () {
        ...
        Route::post('/campaign-crew', [GameSetupController::class, 'submitCampaignCrew'])->name('campaign-crew');
    ...
    Route::prefix('/{game:uuid}/play')->name('play.')->group(function () {
        ...
        Route::post('/crew/tokens/restore', [GamePlayController::class, 'restoreTokens'])->name('crew.tokens.restore');
